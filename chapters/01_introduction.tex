...
The objective of this project is to implement a MATLAB-based simulation tool for the two-dimensional Gray--Scott model and to determine, through systematic verification and benchmarking, which solver approach is the most suitable practical choice for the underlying partial differential equation. The work therefore combines model implementation, numerical testing, and performance comparison within a single software framework.
...
In addition to the scientific and technical literature on the Gray--Scott model, the present PPP followed the official PPP guideline, while the formal and technical aspects of the report were additionally reviewed using guidelines on AI-assisted programming \citep{ppp_guideline_2024, aiass_guideline_2025}.